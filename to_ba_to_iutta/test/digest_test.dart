...
Future<void> testImplementation(DigestData data, Uint8List test1,
  ...
  final algorithm = (await DigestDataSerializer()
          .load(DigestDataSerializer().serialize(mean.data)))
      .newMean;
    ...
    test("Blake", () async {
      ...
      await testImplementation(
          DigestData(
              ...
              BlakeDigestParams(BlakeDigestSize(64, BlakeDigestType.x2b),
                  BlakeDigestType.x2b)),
          test1,
          test2,
      ...
      await testImplementation(
          DigestData(
              DigestImplementation.blake,
              BlakeDigestParams(BlakeDigestSize(1, BlakeDigestType.x2b),
                  BlakeDigestType.x2b)),
          test1,
          test2,
          ListMatcher(Uint8List.fromList((await tester.hash(test1)).bytes)),
      ...
      await testImplementation(
          DigestData(
              DigestImplementation.blake,
              BlakeDigestParams(BlakeDigestSize(32, BlakeDigestType.x2b),
                  BlakeDigestType.x2b)),
          test1,
          test2,
          ListMatcher(Uint8List.fromList((await tester.hash(test1)).bytes)),
      ...
      await testImplementation(
          DigestData(
              DigestImplementation.blake,
              BlakeDigestParams(BlakeDigestSize(32, BlakeDigestType.x2s),
                  BlakeDigestType.x2s)),
          test1,
          test2,
          ListMatcher(Uint8List.fromList((await tester.hash(test1)).bytes)),
      ...
      await testImplementation(
          DigestData(
              DigestImplementation.blake,
              BlakeDigestParams(BlakeDigestSize(1, BlakeDigestType.x2s),
                  BlakeDigestType.x2s)),
          test1,
          test2,
          ListMatcher(Uint8List.fromList((await tester.hash(test1)).bytes)),
