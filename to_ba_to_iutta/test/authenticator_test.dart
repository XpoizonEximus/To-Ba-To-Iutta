...
void main() async {
  group("Implementation", () {
    ...
    test("AesCmac", () async {
      const algorithm = AesCmacAuthenticator(AuthenticatorParams());
    ...
    test("Poly1305", () async {
      final algorithm = Poly1305Authenticator(const AuthenticatorParams());
    ...
    test("Hmac - sha256", () async {
      final algorithm = HashAuthenticator(HashAuthenticatorParams(DigestData(
