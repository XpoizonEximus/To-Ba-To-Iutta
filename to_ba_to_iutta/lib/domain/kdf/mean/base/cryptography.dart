...
abstract class _CryptographyKdf extends Kdf {
  ...
  const _CryptographyKdf(super.params, this._algorithm);
  ...
  @override
  _CryptographyKdfProcessor newProcessor(
          KdfVariables variables,
          {bool syncronized = true}) =>
      _CryptographyKdfProcessor(_algorithm, variables,
          syncronized: syncronized);
}

class _CryptographyKdfProcessor extends KdfProcessor {
  final c.MacAlgorithm _algorithm;
  Future<c.MacSink> _asyncSinkFuture;
  c.MacSink? _asyncSink;
  final dc.DartMacSinkMixin _syncSink;

  _CryptographyKdfProcessor(
    this._algorithm,
    super.variables, {
  ...
  @override
  set variables(KdfVariables variables) => _reset(variables);

  void _reset(KdfVariables variables) {
