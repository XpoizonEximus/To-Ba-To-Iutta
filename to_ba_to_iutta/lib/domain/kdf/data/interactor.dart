...
class KdfDataInteractor extends DataInteractor<KdfData> {
  ...
  @override
  InteractorState<KdfData, Interactor> createState() =>
      KdfDataInteractorState();
}

class KdfDataInteractorState extends DataInteractorState<
    KdfData, KdfDataInteractor> {
  ...
  void initState() {
    _implementation =
        widget.initial.implementation as KdfImplementation;
    super.initState();
  }
