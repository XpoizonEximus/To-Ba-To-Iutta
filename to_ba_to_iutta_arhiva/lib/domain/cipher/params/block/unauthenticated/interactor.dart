...
class UnauntenticatedBlockCipherParamsInteractor
  ...
  const UnauntenticatedBlockCipherParamsInteractor(
      {super.key,
      required UnauthenticatedBlockCipherParams super.initial,
      super.title = "Block cipher parameters",
      super.description =
          "These are the general parameters of the block cipher. Authentication is handles separately using an authenticator."});

  @override
  UnauntenticatedBlockCipherParamsInteractorState createState() =>
      UnauntenticatedBlockCipherParamsInteractorState();
}

class UnauntenticatedBlockCipherParamsInteractorState<
        I extends UnauntenticatedBlockCipherParamsInteractor>
...
typedef UnauntenticatedBlockCipherParamsInteractorKey
    = InteractorKey<UnauntenticatedBlockCipherParamsInteractorState>;
